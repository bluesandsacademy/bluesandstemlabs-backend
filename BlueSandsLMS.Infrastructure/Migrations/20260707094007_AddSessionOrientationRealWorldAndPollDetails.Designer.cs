...
namespace BlueSandsLMS.Infrastructure.Migrations
{
    ...
    [Migration("20260707094007_AddSessionOrientationRealWorldAndPollDetails")]
    partial class AddSessionOrientationRealWorldAndPollDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.IlsDiscussionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IlsId", "CreatedAt");

                    b.HasIndex("SessionId", "CreatedAt");

                    b.ToTable("IlsDiscussionMessages");
                });
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.InteractiveLearningSpace", b =>
                {
                    ...
                    b.Property<string>("AssessmentConfigJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsSharedWithSchool")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.Property<string>("PraxiLabsExperimentId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("SimulationSource")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasDefaultValue("phet");
                    ...
                    b.HasIndex("SchoolId", "IsSharedWithSchool");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.School", b =>
                {
                    ...
                    b.Property<int?>("DisabledStudentCount")
                        .HasColumnType("int");

                    b.Property<int?>("EstimatedScienceStudentCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionAssessment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionOrientation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("EngagementAnswer")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionRealWorld", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SessionRealWorlds");
                });

            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionReflection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.StudentIlsSession", b =>
                {
                    ...
                    b.Property<bool>("ReflectionSubmitted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SupportResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.IlsDiscussionMessage", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.Order", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionAssessment", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.StudentIlsSession", "Session")
                        .WithOne("Assessment")
                        .HasForeignKey("BlueSandsLMS.Core.Entities.SessionAssessment", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionOrientation", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.StudentIlsSession", "Session")
                        .WithOne("Orientation")
                        .HasForeignKey("BlueSandsLMS.Core.Entities.SessionOrientation", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionRealWorld", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.StudentIlsSession", "Session")
                        .WithOne("RealWorld")
                        .HasForeignKey("BlueSandsLMS.Core.Entities.SessionRealWorld", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BlueSandsLMS.Core.Entities.SessionReflection", b =>
                {
                    b.HasOne("BlueSandsLMS.Core.Entities.StudentIlsSession", "Session")
                        .WithOne("Reflection")
                        .HasForeignKey("BlueSandsLMS.Core.Entities.SessionReflection", "SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
